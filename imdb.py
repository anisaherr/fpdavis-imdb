...
with col2:
    ...
    st.markdown("""
                <div style='text-align: justify;'>
                Diagram garis yang ditampilkan menunjukkan pendapatan akhir pekan pembukaan film dari waktu ke waktu, mulai dari tahun 1974 hingga 2024. Dari grafik ini, kita bisa melihat fluktuasi dan tren dalam pendapatan pembukaan film selama beberapa dekade. Terdapat lonjakan signifikan pada beberapa periode tertentu, misalnya, sekitar tahun 2008 dan tahun-tahun berikutnya menunjukkan puncak yang sangat tinggi dalam pendapatan pembukaan. Tren ini juga memperlihatkan bagaimana industri film telah berkembang pesat, dengan peningkatan anggaran pemasaran dan produksi, serta antisipasi penonton yang semakin tinggi terhadap film-film baru. Menggunakan diagram garis adalah pilihan yang tepat karena memungkinkan kita untuk melihat tren temporal secara berkesinambungan, memberikan visualisasi yang jelas tentang bagaimana pendapatan pembukaan film berubah dari tahun ke tahun. 
                </div>
                """, unsafe_allow_html=True)
